...
import { FileManagerService } from '@/app/features/admin/modules/apps/file-manager/data/file-manager';
import { Item } from '@/app/features/admin/modules/apps/file-manager/data/model';
import { FileManagerFileList } from '@/app/features/admin/modules/apps/file-manager/ui/list';
