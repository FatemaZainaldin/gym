...
import Tasks from "@/app/features/admin/modules/apps/tasks/features/tasks";
    ...
    <div class="flex flex-auto">
      ...
      >
        ...
        <div class="-mt-3 -ml-4 flex items-center justify-between">
          <button matButton class="pr-4 pl-3.5">
            <mat-icon
          ...
          <div class="flex items-center">
            ...
            <!-- Close button -->
            <button type="button" matIconButton (click)="closeTask()">
              <mat-icon svgIcon="x" />
            </button>
          </div>
        </div>
