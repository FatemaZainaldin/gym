...
import { Task } from "@/app/features/admin/modules/apps/tasks/data/model";
import { TasksService } from "@/app/features/admin/modules/apps/tasks/data/tasks";
        ...
        >
          ...
          <div class="flex items-center gap-x-4 px-6 py-4 lg:px-10 lg:py-8">
            ...
            <mat-form-field class="w-40 sm:w-64">
              ...
              <input placeholder="Search tasks" matInput />
            </mat-form-field>
            ...
            <div>
              ...
              <mat-menu xPosition="before" #actionsMenu>
          ...
          @if (data.tasks && data.tasks.length > 0) {
            ...
            >
              ...
              @for (task of data.tasks; track task.id; let first = $first) {
                ...
                >
                  <!-- Drag preview -->
                  <div class="flex size-0 flex-0" *cdkDragPreview></div>
                  ...
                  <div class="relative flex h-full items-center pl-10">
                    ...
                    @if (task.type === "task") {
                      <button matIconButton class="mr-2 -ml-2.5 leading-none">
                        @if (task.completed) {
                          <mat-icon
                        ...
                        @if (!task.completed) {
                          <mat-icon class="text-neutral-500" svgIcon="circle" />
                        }
                      </button>
                    }
            ...
            <div class="flex flex-auto flex-col items-center justify-center">
              <mat-icon class="size-12 text-neutral-500" svgIcon="list-todo" />
