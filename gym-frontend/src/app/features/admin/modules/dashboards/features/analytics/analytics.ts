...
import { AnalyticsDashboardService } from "@/app/features/admin/modules/dashboards/data/analytics";
      ...
      <div class="grid w-full grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <mat-card class="overflow-hidden" appearance="outlined">
          <div class="flex flex-col gap-y-2 p-6 pb-0">
            ...
            <div class="flex items-center gap-x-1">
              <mat-icon class="text-red-600" svgIcon="trending-down" />
        ...
        <mat-card class="overflow-hidden" appearance="outlined">
          <div class="flex flex-col gap-y-2 p-6 pb-0">
            ...
            <div class="flex items-center gap-x-1">
              <mat-icon class="text-green-600" svgIcon="trending-up" />
          ...
          <div class="grid grid-cols-1 gap-8 sm:grid-cols-3 sm:gap-12">
            <div class="flex flex-col">
              ...
              <div class="mt-2 flex items-end gap-x-2">
                ...
                <div class="flex items-center gap-x-1">
                  <mat-icon class="text-green-600" svgIcon="arrow-up" />
            ...
            <div class="flex flex-col">
              ...
              <div class="mt-2 flex items-end gap-x-2">
                ...
                <div class="flex items-center gap-x-1">
                  <mat-icon class="text-red-600" svgIcon="arrow-down" />
