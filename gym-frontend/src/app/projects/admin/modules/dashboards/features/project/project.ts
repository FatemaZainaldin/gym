...
import { ProjectDashboardService } from "@/app/projects/admin/modules/dashboards/data/project";
import { ProjectDashboardBudgetTable } from "@/app/projects/admin/modules/dashboards/features/project/budget-table";
  ...
  template: `
    ...
    >
      ...
      <mat-card appearance="filled" class="flex flex-col">
        <mat-card-header>
          <div class="flex flex-auto items-center gap-x-2">
            <mat-icon class="size-4" svgIcon="chart-line" />
          ...
          <mat-card appearance="filled">
            ...
            <mat-card-content>
              ...
              <div class="mt-2 flex items-center gap-x-1">
                @if (item.change.up) {
                  <mat-icon class="size-4 text-green-600" svgIcon="arrow-up" />
                } @else {
                  <mat-icon class="size-4 text-red-600" svgIcon="arrow-down" />
                }
                <div
      ...
      <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-6">
        <!-- Task distribution -->
        <mat-card appearance="filled" class="flex">
          <mat-card-header>
            <div class="flex flex-auto items-center gap-x-2">
              <mat-icon class="size-4" svgIcon="logs" />
        ...
        <mat-card appearance="filled">
          <mat-card-header>
            <div class="flex flex-auto items-center gap-x-2">
              <mat-icon class="size-4" svgIcon="calendar-clock" />
                ...
                <div class="truncate">
                  ...
                  @if (item.location) {
                    <div class="flex items-center">
                      <mat-icon class="size-3" svgIcon="map-pin"></mat-icon>
      ...
      <mat-card appearance="filled" class="flex flex-col">
        <mat-card-header>
          <div class="flex flex-auto items-center gap-x-2">
            <mat-icon class="size-4" svgIcon="wallet" />
