...
import {
  ...
  Transaction,
} from "@/app/projects/admin/modules/dashboards/data/finance";
    ...
    >
      ...
      <div class="flex items-center justify-between gap-x-3">
        ...
        <div class="flex items-center gap-x-3">
          <button class="hidden sm:inline-flex" matButton="outlined">
          ...
          <button class="hidden sm:inline-flex" mat-flat-button>
      ...
      <div class="grid w-full grid-cols-1 gap-6 xl:grid-cols-2">
        <div class="grid gap-8 sm:grid-flow-col xl:grid-flow-row">
          <!-- Previous statement -->
          <mat-card class="overflow-hidden px-5 py-4" appearance="outlined">
          ...
          <div class="my-8 space-y-8">
            <div class="flex flex-col">
              <div class="flex items-center">
                ...
                >
                  <mat-icon class="size-6" svgIcon="credit-card" />
                </div>
            ...
            <div class="flex flex-col">
              <div class="flex items-center">
                ...
                >
                  <mat-icon class="size-6 text-current" svgIcon="banknote" />
                </div>
                <div class="ml-4 flex-auto">
                  <div class="text-sm font-medium text-neutral-500">
                    Savings
            ...
            <div class="flex flex-col">
              <div class="flex items-center">
                ...
                >
                  <mat-icon class="size-6 text-current" svgIcon="plug" />
                </div>
