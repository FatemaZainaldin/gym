  ...
  template: `
    ...
    >
      ...
      <mat-form-field class="col-span-full md:col-span-2">
        ...
        <input matInput [formField]="accountSettingsForm.name" />
      ...
      <mat-form-field class="col-span-full md:col-span-2 md:col-start-1">
        ...
        <input matInput [formField]="accountSettingsForm.username" />
        <div class="text-neutral-500" matPrefix>fusetheme.com/</div>
      </mat-form-field>

      <!-- Title -->
      <mat-form-field class="col-span-full md:col-span-2 md:col-start-1">
        <mat-label>Title</mat-label>
        <input matInput [formField]="accountSettingsForm.title" />
        <mat-icon svgIcon="briefcase-business" matPrefix></mat-icon>
      </mat-form-field>

      <!-- Company -->
      <mat-form-field class="col-span-full md:col-span-2">
        <mat-label>Company</mat-label>
        <input matInput [formField]="accountSettingsForm.company" />
        <mat-icon svgIcon="building-2" matPrefix></mat-icon>
      </mat-form-field>
      ...
      <mat-form-field class="col-span-full md:col-span-2">
        ...
        <input matInput [formField]="accountSettingsForm.email" />
        <mat-icon svgIcon="mail" matPrefix></mat-icon>
        <mat-error>
      ...
      <mat-form-field class="col-span-full md:col-span-2">
        ...
        <input matInput [formField]="accountSettingsForm.phone" />
      ...
      <mat-form-field class="col-span-full md:col-span-2">
        ...
        <mat-icon svgIcon="map-pin" matPrefix></mat-icon>
      </mat-form-field>
      ...
      <mat-form-field class="col-span-full md:col-span-2">
        ...
        <mat-icon svgIcon="globe" matPrefix></mat-icon>
      </mat-form-field>
