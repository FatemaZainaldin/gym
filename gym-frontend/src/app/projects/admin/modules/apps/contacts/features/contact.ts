...
import { ContactsService } from '@/app/projects/admin/modules/apps/contacts/data/contacts';
import Contacts from '@/app/projects/admin/modules/apps/contacts/features/contacts';
