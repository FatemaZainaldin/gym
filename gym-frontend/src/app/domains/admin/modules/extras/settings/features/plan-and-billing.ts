  ...
  template: `
    ...
    >
      ...
      <mat-form-field class="col-span-full">
        ...
        <input matInput [formField]="planAndBillingSettingsForm.cardHolder" />
      ...
      <mat-form-field class="col-span-full md:col-span-2">
        ...
        <input matInput [formField]="planAndBillingSettingsForm.cardNumber" />
        <mat-icon svgIcon="credit-card" matPrefix></mat-icon>
      </mat-form-field>
      ...
      <mat-form-field class="col-span-full md:col-span-1">
        ...
        <input matInput [formField]="planAndBillingSettingsForm.cardCVC" />
        <mat-icon svgIcon="lock-keyhole" matPrefix></mat-icon>
      </mat-form-field>
      ...
      <mat-form-field class="col-span-full md:col-span-1">
        ...
        <input matInput />
        <mat-icon svgIcon="hash" matPrefix></mat-icon>
      </mat-form-field>
