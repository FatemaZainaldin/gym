      ...
      <div class="flex flex-col gap-y-16">
        ...
        <div class="flex flex-col items-start">
          ...
          <div class="relative flex gap-x-4 pb-12">
            ...
            >
              <mat-icon class="text-white" svgIcon="star" />
            </div>
          ...
          <div class="relative flex gap-x-4 pb-12">
            ...
            <div
              class="flex size-10 shrink-0 items-center justify-center rounded-full bg-neutral-500"
            >
              <mat-icon class="text-white" svgIcon="mail" />
            </div>
            <div class="flex flex-col">
              <div class="text-md font-medium">
          ...
          <div class="relative flex gap-x-4">
            ...
            <div
              class="flex size-10 shrink-0 items-center justify-center rounded-full bg-neutral-500"
            >
              <mat-icon class="text-white" svgIcon="box" />
            </div>
            <div class="flex flex-col">
              <div class="text-md font-medium">
        ...
        <div class="flex flex-col items-start">
          ...
          <div class="relative flex gap-x-4 pb-12">
            ...
            <div
              class="flex size-10 shrink-0 items-center justify-center rounded-full bg-neutral-500"
            >
              <mat-icon class="text-white" svgIcon="message-circle" />
            </div>
            <div class="flex flex-col">
              <div class="text-md font-medium">
          ...
          <div class="relative flex gap-x-4">
            ...
            <div
              class="flex size-10 shrink-0 items-center justify-center rounded-full bg-neutral-500"
            >
              <mat-icon class="text-white" svgIcon="message-circle-dashed" />
            </div>
            <div class="flex flex-col">
              <div class="text-md font-medium">
        ...
        <div class="flex flex-col items-start">
          ...
          <div class="relative flex gap-x-4 pb-12">
            ...
            <div
              class="flex size-10 shrink-0 items-center justify-center rounded-full bg-neutral-500"
            >
              <mat-icon class="text-white" svgIcon="user-round-check" />
            </div>
            <div class="flex flex-col">
              <div class="text-md font-medium">
