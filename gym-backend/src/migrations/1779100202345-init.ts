...
export class Init1779100202345 implements MigrationInterface {
    name = 'Init1779100202345'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "nav_items" DROP COLUMN "isdefault"`);
        await queryRunner.query(`ALTER TABLE "nav_items" ADD "isDefault" boolean NOT NULL DEFAULT true`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "nav_items" DROP COLUMN "isDefault"`);
        await queryRunner.query(`ALTER TABLE "nav_items" ADD "isdefault" boolean DEFAULT false`);
